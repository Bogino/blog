...
create table posts (id integer not null auto_increment, is_active integer, moderation_status varchar(255), text varchar(255) not null, time datetime(6), title varchar(255), view_count integer not null, moderator_id integer, user_id integer not null, primary key (id)) engine=InnoDB;
