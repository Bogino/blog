...
create table post_comments (id integer not null auto_increment, parent_id integer, post_id integer not null, user_id integer not null, time datetime(6), text text not null, primary key (id)) engine=InnoDB;
...
create table posts (id integer not null auto_increment, is_active integer, moderation_status varchar(255), text text not null, time datetime(6), title varchar(255), view_count integer not null, moderator_id integer, user_id integer not null, primary key (id)) engine=InnoDB;
...
create table users (id integer not null auto_increment, code varchar(255), email varchar(255), is_moderator integer not null, name varchar(255), password varchar(255), photo text, reg_time datetime(6), primary key (id)) engine=InnoDB;
