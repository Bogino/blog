insert into users (is_moderator, reg_time, name, email, password, code, photo) values(true, CURRENT_DATE, "Vanya", "ivan@yandex.ru", "123", NULL, NULL), (false, CURRENT_DATE, "Sanya", "san@yandex.ru", "1234", NULL, NULL),
...
insert into posts (is_active, moderation_status, text, time, title, view_count, moderator_id, user_id) values(true, "ACCEPTED", "Текст поста от Вани по Java", "2020-12-01 12:34:45", "Заголовок от Вани", 154, 1, 1), (true, "ACCEPTED", "Текст поста от Сани по C#", "2020-12-02 12:34:45", "Заголовок от Сани", 150, 1, 2),
(true, "ACCEPTED", "Текст поста от Сани по Еде", "2020-12-03 12:34:45", "Заголовок от Сани про еду", 120, 1, 2), (true, "ACCEPTED", "Второй текст поста от Сани по Еде", "2020-12-04 12:34:45", "Заголовок второго посата от Сани про еду", 120, 1, 2),
(true, "ACCEPTED", "Третий текст поста от Сани по Еде", "2020-12-05 12:34:45", "Заголовок третьего посата от Сани про еду", 120, 1, 2), (true, "NEW", "Четвертый текст поста от Сани по Еде", "2020-12-06 12:34:45", "Заголовок четвертого посата от Сани про еду", 120, NULL, 2),
